...
class Commands
{
	string Recieptpath = @"..\..\..\Data\reciepts.txt";
	string Refundtpath = @"..\..\..\Data\refunds.txt";
	...
	public void Sum()
	{
		...
		Console.WriteLine($"Total Tickets Sold: {adultTickets + childTickets + seniorTickets} Total Price: {totalPrice}kr");
		...
		Console.WriteLine($"Total Tickets Refunded: {adultTickets + childTickets + seniorTickets}, Total Price: {totalPrice}kr");
...
class Reciept
{
	...
	public int GetPrice()
	{
		tPrice = tPrice + (sTickets * sPrice) + (aTickets * aPrice) + (cTickets * cPrice);
		return tPrice;
	}
	public string Info()
	{
